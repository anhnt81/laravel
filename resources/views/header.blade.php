			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i>Gooner Cart</a></li>
						<li><a href=""><i class="fa fa-phone"></i>0167.207.8358</a></li>
					</ul>
				</div> 
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						...
						<li><a href="{{route('account',Auth::User()->id)}}"><i class="fa fa-user"></i>Tài khoản</a></li>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left" style="width:50%;height:100%">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/logo-cake.jpg" alt=""></a>
				</div>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="{{route('san-pham-moi')}}">Sản Phẩm Mới</a></li>
						<li><a href="{{route('san-pham-km')}}">Sản Phẩm Khuyến Mại</a></li>
