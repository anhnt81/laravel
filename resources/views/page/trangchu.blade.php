								...
								<div class="col-sm-3" style="margin-top:50px">
									...
									@if($s->promotion_price!=0)
										...
										<div class="single-item-header">
											<a href="{{route('sanpham',$s->id)}}"><img src="{{$s->image}}" height="250px" alt=""></a>
										</div>
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('them-gio-hang',$s->id_product)}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="{{route('sanpham',$s->id_product)}}">Chi Tiết <i class="fa fa-chevron-right"></i></a>
